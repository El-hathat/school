...
function page() {
  return (
    ...
    <div  className="w-full  max-w-sm mx-auto overflow-hidden bg-white bg-opacity-30  rounded-lg shadow-md  ">
    <div  className="px-6 py-4">
        ...
        <form>
            <div  className="w-full mt-4">
                <input  className="block w-full px-4 py-2 mt-2 text-white placeholder-gray-500 bg-white bg-opacity-30  border rounded-lg    focus: border-[#ff8367]  focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="email" placeholder="Email Address" aria-label="Email Address" />
            </div>

            <div  className="w-full mt-4">
                <input  className="block w-full px-4 py-2 mt-2 text-white placeholder-gray-500 bg-white bg-opacity-30  border rounded-lg   focus: border-[#ff8367]  focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300" type="password" placeholder="Password" aria-label="Password" />
            </div>

            <div  className="flex items-center justify-between mt-4">
                <a href="#"  className="text-sm text-white dark:text-gray-200 hover:text-white">Forget Password?</a>
