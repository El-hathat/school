...
function Footer() {
  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <ul className="flex items-center gap-6 text-sm">
          ...
          <li>
            <a className=" text-white transition hover:text-[#ff8367]" href="#" > Services </a>
          </li>
        ...
        <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end" data-aos="fade-up">
          <li>
            <a
              href="#"
              rel="noreferrer"
      ...
      <div
        className="grid grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 lg:flex lg:flex-row lg:justify-between"
      >
    ...
    <Image src={circle} alt='' className='hidden lg:flex w-16 h-16 relative top-[70%] left-[60%]'/>
        ...
        <div >
          <p className="font-medium text-white text-lg ">Instagram</p>
  
          <ul className="mt-6  text-sm flex   justify-between flex-wrap w-[220px] h-[220px]">
            <li className='w-[100px] h-[100px]    rounded-md'>
              <a href="#" className="text-white transition "> <img className='w-full h-full rounded-md' src="https://images.unsplash.com/photo-1631451095765-2c91616fc9e6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80" alt="" /> </a>
            </li>
            <li className='w-[100px] h-[100px]    rounded-md'>
              <a href="#" className="text-white transition  "> <img className='w-full h-full rounded-md' src="https://images.unsplash.com/photo-1631451095765-2c91616fc9e6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80" alt="" /> </a>
            </li>
        ...
        <div className="hidden w-[10%] lg:flex">
    <Image src={circle} alt='' className='hidden lg:flex w-16 h-16 relative top-[10%] left-[60%]'/>

    </div>
      </div>
  
      </div>
    <p className="text-sm text-white bg-gray-500 w-full h-16 text-center pt-5">&copy; 2024. NL agency. All rights reserved.</p>
